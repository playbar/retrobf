 ...
 *
 */
public class BFSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    private final static String TAG = "BFSurfaceView";
     ...
     */
    public BFSurfaceView(Context context) {
        super(context);
        init();
    }
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public BFSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    private static class EglHelper {
        public EglHelper(WeakReference<BFSurfaceView> glSurfaceViewWeakRef) {
        ...
        public void start() {
            ...
            BFSurfaceView view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        private WeakReference<BFSurfaceView> mGLSurfaceViewWeakRef;
        EGL10 mEgl;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<BFSurfaceView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
    ...
    private final WeakReference<BFSurfaceView> mThisWeakRef = new WeakReference<BFSurfaceView>(this);
