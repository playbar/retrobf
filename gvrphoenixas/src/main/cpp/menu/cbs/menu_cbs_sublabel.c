...
static int action_bind_sublabel_core_list(file_list_t *list, unsigned type, unsigned i, const char *label, const char *path, char *s, size_t len)
{
   strlcpy(s, msg_hash_to_str(MENU_ENUM_SUBLABEL_CORE_LIST), len);
   return 0;
}
...
static int action_bind_sublabel_resume_content(file_list_t *list, unsigned type, unsigned i, const char *label, const char *path, char *s, size_t len)
{
   strlcpy(s, msg_hash_to_str(MENU_ENUM_SUBLABEL_RESUME_CONTENT), len);
   return 0;
}
...
static int action_bind_sublabel_netplay_use_mitm_server(file_list_t *list, unsigned type, unsigned i, const char *label, const char *path, char *s, size_t len)
{
   strlcpy(s, msg_hash_to_str(MENU_ENUM_SUBLABEL_NETPLAY_USE_MITM_SERVER), len);
   return 0;
}
   ...
   if (cbs->enum_idx != MSG_UNKNOWN)
   {
      switch (cbs->enum_idx)
      {
         ...
         case MENU_ENUM_LABEL_RESUME_CONTENT:
            cbs->action_sublabel = action_bind_sublabel_resume_content;
            cbs->action_sublabel_ident = "action_bind_sublabel_resume_content";
            break;
         ...
         case MENU_ENUM_LABEL_CORE_LIST:
              cbs->action_sublabel = action_bind_sublabel_core_list;
              cbs->action_sublabel_ident = "action_bind_sublabel_core_list";
              break;
